...
An web application for citizens to submit locations for bike parking around toronto
...
.. code-block:: bash
    ...
    cd bike_parking_toronto
    celery -A bike_parking_toronto.taskapp worker -l info
