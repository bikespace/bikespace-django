...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres' # os.getenv ('POSTGRES_USER', 'postgres'),
        'PASSWORD': 'bikeparking' # os.getenv ('POSTGRES_PASSWORD', 'bikeparking'),
        'HOST': 'postgres' # os.getenv ('BIKE_DB_HOST', 'localhost'),
        'PORT': '5432'
    },
    'geospatial' : {
        'ENGINE': 'django.db.backends.postgresql_psycopg2',
